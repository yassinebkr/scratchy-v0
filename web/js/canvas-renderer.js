...
// Safe innerHTML helper — uses DOMPurify if available, otherwise raw innerHTML
function safeHTML(el, html) {
  if (typeof DOMPurify !== "undefined") {
    el.innerHTML = DOMPurify.sanitize(html, { ADD_ATTR: ["data-sui-send","data-sui-form","onclick","onmouseover","onmouseout","onfocus","onblur","style"] });
  } else {
    el.innerHTML = html;
  }
}
