 ...
 * 
 * rpID is auto-detected: "localhost" for local dev, "scratchy.example.com" for production.
 * Origin follows suit: http://localhost:3001 (dev) or https://scratchy.example.com (prod).
 */
...
const PROD_RP_ID = "scratchy.example.com";
const PROD_ORIGIN = "https://scratchy.example.com";
